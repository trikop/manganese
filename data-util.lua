...
util.manganese_plate = ""
util.manganese_processing = ""

if mods["FactorioExtended-Plus-Core"] then
  util.manganese_plate = "manganese-alloy"
else
  util.manganese_plate = "manganese-plate"
end

if mods["pyrawores"] then 
  util.manganese_processing = "manganese-mk01"
else
  util.manganese_processing = "manganese-processing"
end
