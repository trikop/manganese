...
{
  {
    ...
    icon_mipmaps = 3,
    pictures = {
      {filename="__manganese__/graphics/icons/enriched-manganese.png", size=64, scale=0.25},
      {filename="__manganese__/graphics/icons/enriched-manganese-1.png", size=64, scale=0.25},
      {filename="__manganese__/graphics/icons/enriched-manganese-2.png", size=64, scale=0.25},
      {filename="__manganese__/graphics/icons/enriched-manganese-3.png", size=64, scale=0.25},
    },
